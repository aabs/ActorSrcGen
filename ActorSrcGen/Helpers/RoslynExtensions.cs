...
#pragma warning restore CS8600
    ...
    public static bool IsStartStep(this IMethodSymbol method)
    {
        return method?
            .GetAttributes()
            .Any(a => a.AttributeClass!.Name.Equals(nameof(FirstStepAttribute), StringComparison.InvariantCultureIgnoreCase)) ?? false;
    }
    ...
    public static bool IsEndStep(this IMethodSymbol method)
    {
        return method?
            .GetAttributes()
            .Any(a => a.AttributeClass!.Name.Equals(nameof(LastStepAttribute), StringComparison.InvariantCultureIgnoreCase)) ?? false;
    }
}
